...
std::map<std::string, Material> materials = {
    {"red", Material(Color(0.75, 0.25, 0.25), Color(), ReflectionType::DIFFUSE)},
    {"blue", Material(Color(0.25, 0.25, 0.75), Color(), ReflectionType::DIFFUSE)},
    {"gray", Material(Color(0.75, 0.75, 0.75), Color(), ReflectionType::DIFFUSE)},
    {"black", Material(Color(), Color(), ReflectionType::DIFFUSE)},
    {"cyan", Material(Color(0.25, 0.75, 0.75), Color(), ReflectionType::DIFFUSE)},
    {"specular", Material(Color(0.99, 0.99, 0.99), Color(), ReflectionType::SPECULAR)},
    {"refraction", Material(Color(0.99, 0.99, 0.99), Color(), ReflectionType::REFRACTION)},
    {"light", Material(Color(), Color(36, 36, 36), ReflectionType::DIFFUSE)},
    {"week_light_1", Material(Color(), Color(25, 25, 25), ReflectionType::DIFFUSE)},
    {"week_light_2", Material(Color(), Color(5, 5, 5), ReflectionType::DIFFUSE)},
    {"green", Material(Color(0.25, 0.75, 0.25), Color(), ReflectionType::DIFFUSE)}};
...
bool build_from_plyfile(Scene& scene) {
    ...
    for (int i = 0; i < n_lights; i++) {
        ...
        sphere_ptr =
            new Sphere(0.1, Vec(10.0 * rand() - 5., 10.0 * rand(), 10.0 * rand() - 5.), material);
        scene.add_object(sphere_ptr);
    }
